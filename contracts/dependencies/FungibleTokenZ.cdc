...
pub contract interface FungibleTokens {
    ...
    ///pub event TokensInitialized(tokenID: UInt64, tokenName: String, tokenSymbol: String)
    ...
    pub resource Vault: Provider, Receiver, Balance {
        ...
        // every Fungible TokenZ contract that implements the FungibleTokens interface
        ...
        // that allows prioviding the Vault's tokenID and initial balance of the Vault
        //
        init(tokenID: UInt64, balance: UFix64)
        ...
        pub fun deposit(from: @Vault) {
            ...
            pre {
                from.isInstance(self.getType()) && from.tokenID == self.tokenID: 
